            ...
            <div class="alert alert-danger alert-dismissible">
                ...
                <form method="POST" action="{{ url('/stok/'.$stok->stok_id) }}" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <select class="form-control" id="barang_id" name="barang_id" required readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <select class="form-control" id="user_id" name="user_id" required readonly>
                                <option value="">- Pilh Penanggung Jawab -</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="datetime-local" class="form-control" id="stok_tanggal" name="stok_tanggal" value="{{ old('stok_tanggal', $stok->stok_tanggal) }}" required readonly>
                            @error('stok_tanggal')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
